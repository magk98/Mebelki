<template>
  <div class="flex flex-col space-y-8">
    <div>
      <a-header>
        Kolor
        <color-picker class="pt-2" :colorNames="['red', 'green', 'blue']" />
      </a-header>
    </div>
    <div>
      <a-header>
      ...
      <Slider v-model="priceRange" :format="(value) => `${Math.floor(value)} zł`" :max="4500" :classes="{
...
export default {
  components: { Slider, AHeader, ColorPicker },
  name: 'Filters',
  data() {
    return {
